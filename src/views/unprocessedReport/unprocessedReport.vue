  ...
  methods: {
    ...
    getList() {
      ...
      if (this.changeStatus !== '') {
        reportCondition['if'] = this.changeStatus
      }
    ...
    showDetail(report) {
      ...
      fetchDetail({
        ...
        this.report.college = this.collegeFormat(this.report.college.$numberDouble)
